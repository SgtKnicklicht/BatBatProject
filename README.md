...
- **BatBat Plot**: import Neware `.xlsx`, `.csv`, and `.tsv` files, choose method presets such as CV, CD, rate scan, dQ/dV, EIS, and GITT, plot data in light or dark mode, and export selected plot tables.

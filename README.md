...
- **Channels**: browser-local 5 x 8 Neware reservation board with compact 40-channel layout, per-channel action menus, shift/control multi-select, fast double-click reserve, and CSV export.
